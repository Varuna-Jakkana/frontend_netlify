      ...
      <div id="featuresSection" className="px-8 py-20 bg-[#f6f4ef]">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            <img src={soilImg} alt="soil" className="rounded-3xl shadow-lg" />

            <div className="absolute bottom-6 left-6 text-white">
              <p className="text-xs opacity-80">{t("trusted")}</p>
              <p className="text-2xl font-bold">{t("tagline")}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-600 text-sm mt-2">{t("feature1Desc")} </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-600 text-sm mt-2">{t("feature2Desc")}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-600 text-sm mt-2">{t("feature3Desc")}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <p className="text-gray-600 text-sm mt-2">{t("feature4Desc")}</p>
            </div>
          </div>
        </div>
      </div>
